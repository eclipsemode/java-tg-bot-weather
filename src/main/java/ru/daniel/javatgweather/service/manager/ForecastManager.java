...
import ru.daniel.javatgweather.dto.Data;
import ru.daniel.javatgweather.dto.WeatherResponse;
import ru.daniel.javatgweather.service.WeatherService;
    ...
    private BotApiMethod<?> sendResult(CallbackQuery query, String type, String cityName, Bot bot) {
        ...
        for (Data data : weatherResponse.getData()) {
            sb.append("\uD83D\uDCCD +").append(number).append(")\n")
                    ...
                    .append("Скорость ветра: ").append(data.getWindSpeed()).append("\n")
